...
import com.llyycci.create_tweaked_controllers.gui.ModMenuTypes;
import com.llyycci.create_tweaked_controllers.gui.ControllerItemSlot;
...
public class TweakedLinkedControllerMenu extends GhostItemMenu<ItemStack> {
	private boolean isSecondPage = false;// 是否是第二页
