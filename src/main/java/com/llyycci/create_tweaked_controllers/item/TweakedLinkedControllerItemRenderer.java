...
import com.llyycci.create_tweaked_controllers.controller.TweakedLinkedControllerClientHandler.Mode;
...
{
	protected static final PartialModel BASE = new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/powered"));
	protected static final PartialModel CONTROLLERS[] =
			{
					new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/controller_x")),
					new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/controller_n")),
					new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/controller_p"))

			};
	protected static final PartialModel BUTTON = new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/button"));
	protected static final PartialModel JOYSTICK = new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/joystick"));
	protected static final PartialModel TRIGGER = new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/trigger"));
	protected static final PartialModel BUTTONS_LEFT[] =
			{
					new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/button_x_x")),
					new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/button_n_y")),
					new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/button_p_s"))
			};
	protected static final PartialModel BUTTONS_UP[] =
			{
					new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/button_x_y")),
					new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/button_n_x")),
					new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/button_p_t"))
			};
	protected static final PartialModel BUTTONS_DOWN[] =
			{
					new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/button_x_a")),
					new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/button_n_b")),
					new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/button_p_x"))
			};
	protected static final PartialModel BUTTONS_RIGHT[] =
			{
					new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/button_x_b")),
					new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/button_n_a")),
					new PartialModel(Create_Tweaked_Controllers.asResource("item/tweaked_linked_controller/button_p_c"))
			};
