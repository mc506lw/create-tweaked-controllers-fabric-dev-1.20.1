...
public class JoystickAxisScreen extends GenericInputScreen {
    ...
    protected void renderWindow(GuiGraphics graphics, int x, int y, float partialTicks) {
        ...
        graphics.drawString(font, Create_Tweaked_Controllers.translateDirect("gui_config_lower"), width / 2 - boundsTextWidth, height / 2 - 50, 0xaaaaaa);
        graphics.drawString(font, Create_Tweaked_Controllers.translateDirect("gui_config_upper"),width / 2 - boundsTextWidth, height / 2 - 25, 0xaaaaaa);
    ...
    protected void Populate() {
        ...
        bounds[0] = new EditBox(font, width / 2, height/2 - 55, 90, 20, Create_Tweaked_Controllers.translateDirect("gui_config_lower"));
        bounds[0].setValue(GetSafeFloatString(source.minBound));
        bounds[1] = new EditBox(font, width / 2, height/2 - 30, 90, 20, Create_Tweaked_Controllers.translateDirect("gui_config_upper"));
