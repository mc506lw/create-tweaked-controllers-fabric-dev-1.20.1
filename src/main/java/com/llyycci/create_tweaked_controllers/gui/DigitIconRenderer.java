...
public class DigitIconRenderer implements ScreenElement {
    public static final ResourceLocation DIGIT_ATLAS = Create_Tweaked_Controllers.asResource("textures/gui/digits.png");
    ...
    public void render(GuiGraphics graphics, int x, int y) {
        graphics.blit(DIGIT_ATLAS, x, y, 0, digitX, digitY, DIGIT_WIDTH, DIGIT_HEIGHT, DIGIT_ATLAS_SIZE, DIGIT_ATLAS_SIZE);
    }
