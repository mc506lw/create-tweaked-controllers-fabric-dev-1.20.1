...
import com.llyycci.create_tweaked_controllers.gui.InputConfig.JoystickButtonScreen;
...
public class JoystickButtonInput implements GenericInput {
    ...
    public MutableComponent GetDisplayName() {
        return Create_Tweaked_Controllers.translateDirect("gui_input_joystick_button", ""+buttonID);
    }
