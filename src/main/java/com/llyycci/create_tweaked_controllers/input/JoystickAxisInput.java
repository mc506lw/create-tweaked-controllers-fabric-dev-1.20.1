...
import com.llyycci.create_tweaked_controllers.gui.InputConfig.JoystickAxisScreen;
...
public class JoystickAxisInput implements GenericInput {
    ...
    public MutableComponent GetDisplayName() {
        if (minBound >= 0 && maxBound >= 0) {
            return Create_Tweaked_Controllers.translateDirect("gui_input_joystick_axis", "+"+axisID);
