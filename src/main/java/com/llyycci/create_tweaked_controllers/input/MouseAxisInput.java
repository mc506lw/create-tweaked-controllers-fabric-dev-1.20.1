...
import com.llyycci.create_tweaked_controllers.gui.InputConfig.MouseAxisScreen;
...
public class MouseAxisInput implements GenericInput
{
    ...
    public MutableComponent GetDisplayName()
    {
        ...
        if (useVelocity)
        {
            return Create_Tweaked_Controllers.translateDirect("gui_input_cursor_vel", a);
        }
        else
        {
            return Create_Tweaked_Controllers.translateDirect("gui_input_cursor_pos", a);
        }
