...
import com.llyycci.create_tweaked_controllers.gui.InputConfig.MouseButtonScreen;
...
public class MouseButtonInput implements GenericInput {
    ...
    public MutableComponent GetDisplayName() {
        return Create_Tweaked_Controllers.translateDirect("gui_input_mouse", ""+buttonID);
    }
